      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
        <div className="flex items-baseline gap-3">
          <Link href="/copilot" className="text-lg font-semibold tracking-tight">
            Meridian <span className="text-indigo-700">HR Copilot</span>
          </Link>
        </div>
  ...
  return (
    <label className="flex items-center gap-2 text-xs text-[hsl(var(--muted-foreground))]">
      ...
      <select
        ...
        className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-md px-2 py-1.5 text-sm text-[hsl(var(--foreground))] focus:outline-none focus:ring-2 focus:ring-indigo-600/60"
      >
        {options.map((o) => (
